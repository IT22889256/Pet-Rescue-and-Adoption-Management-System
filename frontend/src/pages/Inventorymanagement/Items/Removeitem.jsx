...
export default function Removeitem() {
  ...
  const handleDelete = () => {
    ...
    axios
      .delete(`http://localhost:3000/inventoryManager/items/removeitem/${id}`)
      .then(() => {
        alert('deleted')
       ...
       onClick={handleDelete}
         >
           Yes, Delete it
              ...
              <Link to={`/inventoryManager/items/viewitem/${item._id}`} className="px-6 py-2.5 rounded-md text-black text-sm font-semibold border-none outline-none bg-gray-200 hover:bg-gray-300 active:bg-gray-200 text-center">Cancel</Link>
