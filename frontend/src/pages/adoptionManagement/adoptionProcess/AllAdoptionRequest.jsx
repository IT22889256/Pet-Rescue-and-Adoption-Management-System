    ...
    <>
      <div className="bg-[#f8fafc] px-4 pt-3 pb-4 rounded-sm border border-gray-200 flex-1">
        ...
        <div className="text-xs text-gray-400 pl-1.5 mb-1 float-right mt-1">
          <Link
            to="/adoptionManager/adoptionProcess/"
            className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"
          >
            Generate Adopted Pet Report
          </Link>
        </div>
                  ...
                  (adoptionProcess) =>
                    adoptionProcess.adopter_status === "Pending" && (
                      <tr
                        ...
                        key={adoptionProcess._id}
                      >
                        <td>{adoptionProcess._id}</td>
                  ...
                  (adoptionProcess) =>
                    adoptionProcess.adopter_status !== "Pending" && (
                      ...
                      >
                        ...
                        <td>
                          <Link
                            to={`/adoptionManager/adoptionRequest/viewRequest/${adoptionProcess._id}`}
                            className=" bg-blue-500 text-white py-2 px-3 rounded hover:bg-blue-700 text-xs text-gray-400  text-center text-justify ml-1 "
                          >
                            View
                          </Link>
