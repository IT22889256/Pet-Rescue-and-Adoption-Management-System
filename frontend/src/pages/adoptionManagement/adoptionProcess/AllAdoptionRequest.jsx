...
export default function AllAdoptionRequest() {
	...
	return (<>
		<div className="bg-[#f8fafc] px-4 pt-3 pb-4 rounded-sm border border-gray-200 flex-1">
			...
			<div className="text-xs text-gray-400 pl-1.5 mb-1 float-right mt-1"><Link to='/adoptionManager/adoptionProcess/' className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Create Rescue Request</Link></div>
					...
					{<tbody>
						{adoptionProcesses.map((adoptionProcess) => (
								...
								<td>
									...
									{adoptionProcess.rescue_request_status=== "Reject" && (
