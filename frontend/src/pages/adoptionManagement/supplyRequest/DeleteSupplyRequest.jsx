        ...
        <div className="w-full max-w-md bg-white shadow-lg rounded-md p-6 relative">
          ...
          <div className="flex flex-col space-y-2">
            ...
            >
              ...
              <Link to={`/adoptionManager/PetSupply`} className="px-6 py-2.5 rounded-md text-black text-sm font-semibold border-none outline-none bg-gray-200 hover:bg-gray-300 active:bg-gray-200 text-center">Cancel</Link>
          </div>
        </div>
      </div>
  )
