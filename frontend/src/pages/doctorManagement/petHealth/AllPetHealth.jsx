	...
	return (<>
		<div className="bg-[#f8fafc] px-4 pt-3 pb-4 rounded-sm border border-gray-200 flex-1">
			...
			<div className="text-xs text-gray-400 pl-1.5 mb-1 float-right mt-1">
				{/* <Link to='/doctor/petHealth/' className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Generate Adopted Pet Report</Link> */}
				</div>
				...
				<table className="bg-[#f3f3f3] w-full text-gray-700">
					...
					{<tbody>
						{petsHealth.map((petHealth) => (
							...
							<tr className='border-b-2 border-[#c1c3c558] text-center' key={petHealth.pet_id}>
								<td>
									{petHealth.pet_id}
								</td >
								{/* <td>
