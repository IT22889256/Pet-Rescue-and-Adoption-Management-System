...
export default function RescueRequest() {
	...
	return (
		<div className="bg-[#f8fafc] px-4 pt-3 pb-4 rounded-sm border border-gray-200 flex-1">
			...
			<div className="text-xs text-gray-400 pl-1.5 mb-1 float-right mt-1"><Link to='/rescueRequest' className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Generate Report</Link></div>
					...
					<tbody>
						{recentRequestData.map((request) => (
							<tr className='border-b-2 border-[#c1c3c558] text-center' key={request.id}>
								...
								<td>
									<Link to='/petManager/rescueRequest/viewRescueRequest' className=" bg-blue-500 text-white py-2 px-2 rounded hover:bg-blue-700 text-xs text-gray-400  text-center text-justify m-2 ">View</Link>
								</td>
							</tr>
						))}
					</tbody>
