...
export default function EditSponPet() {
    ...
    <div className="mt-2">
        <div className="flex items-center mb-4">
            ...
            />
            <label htmlFor="cat" className="ml-2 text-sm text-gray-900">
                Cat
            </label>
        </div>
        ...
        <div className="flex items-center">
            <input
                ...
                className="focus:ring-indigo-600 h-4 w-4 text-indigo-600 border-gray-300 rounded"
            />
            <label htmlFor="dog" className="ml-2 text-sm text-gray-900">
                Dog
            </label>
        </div>
    </div>
    ...
    <div className="mt-2">
        <div className="flex items-center mb-4">
            <input
                ...
                onChange={() => setHealStatus('Good')}
                className="focus:ring-indigo-600 h-4 w-4 text-indigo-600 border-gray-300 rounded"
            />
            <label htmlFor="good" className="ml-2 text-sm text-gray-900">
                Good
            </label>
        </div>
        ...
        <div className="flex items-center mb-4">
            <input
                ...
                onChange={() => setHealStatus('Need Treatment')}
                className="focus:ring-indigo-600 h-4 w-4 text-indigo-600 border-gray-300 rounded"
            />
            <label htmlFor="need-treatment" className="ml-2 text-sm text-gray-900">
                Need Treatment
            </label>
        </div>
        ...
        <div className="flex items-center">
            <input
                ...
                onChange={() => setHealStatus('Treating')}
                className="focus:ring-indigo-600 h-4 w-4 text-indigo-600 border-gray-300 rounded"
            />
            <label htmlFor="treating" className="ml-2 text-sm text-gray-900">
                Treating
            </label>
        </div>
    </div>
