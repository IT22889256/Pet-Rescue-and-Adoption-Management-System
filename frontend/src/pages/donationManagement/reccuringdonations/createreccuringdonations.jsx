...
// import { PhotoIcon} from '@heroicons/react/24/solid'
export default function CreateReccuringDonation() {
    ...
    const Submit = (e) => {
        ...
        console.log('result')
        axios.post('http://localhost:3000/donationManager/reccuringdonation/add',data)
        .then(result => {
            console.log(result)
        ...
        return (
            ...
            <div>
                    <div className="space-y-12">
                        ...
                        <div className='text-xl font-bold '>Create Reccuing Donations</div>
