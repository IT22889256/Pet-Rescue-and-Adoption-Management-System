		...
		<div className="border-t border-gray-200">
			...
			<div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
				...
				<div className="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
					...
					<Link to={`/employeeManager/employees/deleteEmployee/${employee._id}`} className="  bg-red-500 text-white py-2 px-2 rounded hover:bg-red-700 text-xs text-gray-400  text-center text-justify ml-1  ">Remove</Link>
				</div>	
				</div>
			</dl>
		</div>
