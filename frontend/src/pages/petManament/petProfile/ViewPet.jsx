            ...
            <div className="bg-white shadow overflow-hidden sm:rounded-lg">
                ...
                <div className="border-t border-gray-200">
					...
					<div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            ...
                            <dd className="mt-1 text-lg text-gray-900 sm:col-span-2">{Pet.pet_id}</dd>
                        </div>
                        <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            <dt className="text-lg font-medium text-black-500">Request ID</dt>
                            <dd className="mt-1 text-lg text-gray-900 sm:col-span-2">{Pet.rescue_req_id}</dd>
                        </div>
                        <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            <dt className="text-lg font-medium text-black-500">Task ID</dt>
                            <dd className="mt-1 text-lg text-gray-900 sm:col-span-2">{Pet.rescue_task_id}</dd>
                        </div>
                        <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
