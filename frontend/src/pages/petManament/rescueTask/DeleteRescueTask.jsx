...
export default function RemovePet() {
  ...
  const handleDeleteTask = () => {
    axios
      .delete(`http://localhost:3000/petManager/rescueTask/editRescueTask/${id}`)
      .then(() => {
        alert('deleted')
     ...
     onClick={handleDeleteTask}
       >
         Yes, Delete it
            ...
            <Link to={`/petManager/rescueTask/viewRescueTask/${rescueTasks._id}`} className="px-6 py-2.5 rounded-md text-black text-sm font-semibold border-none outline-none bg-gray-200 hover:bg-gray-300 active:bg-gray-200 text-center">Cancel</Link>
