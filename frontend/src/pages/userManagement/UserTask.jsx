  ...
  return (
    <div className="bg-[#f8fafc] px-4 pt-3 pb-4 rounded-sm border border-gray-200 flex-1">
      ...
      <div className="text-xs text-gray-400 pl-1.5 mb-1 float-right mt-1">
        <Link
          to="/petManager/rescueTask/createPetTask"
          ...
          <tbody>
            {recentRescueTasksData.map((request) => (
              ...
              >
                ...
                <td>
                  <Link
                    to="/petManager/rescueTask/viewRescueTask"
                    className=" bg-blue-500 text-white py-2 px-2 rounded hover:bg-blue-700 text-xs text-gray-400  text-center text-justify m-2 "
                  >
                    View
                  </Link>
                  <Link
                    to="/petManager/rescueTask/editRescueTask"
                    className="bg-blue-500 text-white py-2 px-2 rounded hover:bg-blue-700 text-xs text-gray-400  text-center text-justify m-2 "
                  >
                    Edit
                  </Link>
                  <Link
                    to="/petManager/rescueTask/deleteRescueTask"
                    className="bg-blue-500 text-white py-2 px-2 rounded hover:bg-blue-700 text-xs text-gray-400  text-center text-justify m-2 "
                  >
                    Remove
                  </Link>
